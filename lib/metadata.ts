...
export function toMetadataGroup(record: any): MetadataGroupSummary {
  return {
    ...
    reportGroupBy: String(record.reportGroupBy ?? "user"),
    reportGroupQuestionId: String(record.reportGroupQuestionId ?? ""),
    reportCountBy: String(record.reportCountBy ?? "record"),
    reportCountQuestionId: String(record.reportCountQuestionId ?? ""),
    reportSumIds: ids(record.reportSumIds),
